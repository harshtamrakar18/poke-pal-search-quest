  ...
  return (
    <div className="flex flex-col items-center justify-center py-16">
      <div className="relative w-16 h-16">
        ...
        <div className="absolute top-4 left-4 w-8 h-8 bg-white border-4 border-pokedex-darkGray rounded-full">
      ...
      <p className="mt-4 text-lg font-medium text-gray-600">Loading Pokémon...</p>
    </div>
  );
};
